...
// Update Blog by id
router.put("/UpdateBlogs/:blogId",mw.login,mw.Authorization, blogController.update);

// Delete Blog by id
router.delete("/deleteBlogsById/:blogId",mw.login,mw.Authorization, blogController.deleteBlog);
